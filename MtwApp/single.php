...
<body>
        ...
        <div class="content">
            <div id="user_timeline">
                <div id="user_details">
                    ...
                    echo "
                    <center>
                    <img src='users/images/$user_image' width='200' height='200'>
                    </center>
                    <div id='user_mention'>
    ...
    <div id="content_timeline">
        <form action="home.php?id=<?php echo $user_id;?>" method="POST" id="f" >
            <h2> What's your question Today? Let's discuss! </h2> <br>
            <input type="text" name="title" placeholder="Write a Title" size="83" required > <br> <br>
            <textarea name="content" placeholder="Write a Description..." id="" cols="73" rows="4" required style="resize: none;"></textarea> <br><br>
        ...
        <?php insertPost(); ?> <br>
            <h3 style="text-align:left; "> Most Recent Discussions! </h3> <br>
            <?php single_post(); ?>
    </div> 
</body>
</html>