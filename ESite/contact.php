                ...
                <div>
                    <div> 
                        <form action="" method="post" enctype="multipart/form-data" >
                                    <table width="800px" height="50" bgcolor="#242729" align="center" cellpadding="10px;" cellspacing="30"> 
                                        <tr align="center">
                                            <td colspan="2"> <h2 > Contact us </h2> <hr> </td> 
                                        </tr> 
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td> <textarea name="" cols="30" rows="10" noresize></textarea> </td> 
                                        </tr>
